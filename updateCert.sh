...
certificate_pem="/etc/letsencrypt/live/bscrape.com/cert.pem"
cert_chain_pem="/etc/letsencrypt/live/bscrape.com/chain.pem"
private_key_pem="/etc/letsencrypt/live/bscrape.com/privkey.pem"
